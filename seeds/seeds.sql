...
USE itemsdb;
    ...
    INSERT INTO `items` (itemName, itemPrice, itemDescription, itemLocation, itemImage, createdAt, updatedAt) 
    VALUES ("Toyota Camry", "10", "Longboard for beginners!", "Laguna Beach", "Image", now(), now());

    INSERT INTO `items` (itemName, itemPrice, itemDescription, itemLocation, itemImage, createdAt, updatedAt) 
    VALUES ("Puppy", "10", "Longboard for beginners!", "Laguna Beach", "Image", now(), now());

    INSERT INTO `items` (itemName, itemPrice, itemDescription, itemLocation, itemImage, createdAt, updatedAt) 
    VALUES ("Laptop", "10", "Longboard for beginners!", "Laguna Beach", "Image", now(), now());

    INSERT INTO `items` (itemName, itemPrice, itemDescription, itemLocation, itemImage, createdAt, updatedAt) 
    VALUES ("Kite", "10", "Longboard for beginners!", "Laguna Beach", "Image", now(), now());